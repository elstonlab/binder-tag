...
sourcedir = 'C:\\Users\\mike\\Documents\\GitHub\\binder-tag\\initial_review\\CAtagSrc_vs_Binder_analysis\\20201212\\results\\';
...
meas1=load([sourcedir '20201215measured_cluster_props.mat']);
allmeas.tag_prop=[meas1.tag_prop];
allmeas.bin_prop=[meas1.bin_prop];

anal1=load([sourcedir '20201215analyzed_cluster_props_maxRI4-00s_minTrk10.mat']);
allanal_propdists_tag=[anal1.propdists.tag];
allanal_propdists_bin=[anal1.propdists.bin];

% We needed to re-load the experimental data for these follow-up analyses
[path1_tag,file1_tag]=batchGetPath('C:\\Users\\mike\\Documents\\GitHub\\binder-tag\\initial_review\\CAtagSrc_vs_Binder_analysis\\20201212\\results\\inputdata\\','RightCali_lvPALM','mat');

[path1_bin,file1_bin]=batchGetPath('C:\\Users\\mike\\Documents\\GitHub\\binder-tag\\initial_review\\CAtagSrc_vs_Binder_analysis\\20201212\\results\\inputdata\\','Left_lvPALM','mat');
