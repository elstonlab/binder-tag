...
analyze_cluster_props(dateprefix,suffix.cluster_props,suffix.cluster_analysis,nMinTracks,maxRIcutoff); % outputs [dateprefix suffix.cluster_analysis] and lots of figures
analyze_overall_props(dataloc,vbSPTDirLoc,vbSPTMetaDirLoc,dateprefix,suffix.cluster_props,suffix.cluster_analysis,nMinTracks,suffix.overall_analysis); % outputs [dateprefix suffix.overall_analysis] and lots of figures
