...
for field_id=1:2
    ...
    parfor i=1:ncells
       ...
       if strcmp(fields{field_id},'tag')
           curr_thresh = threshold_data.tag_cutoffs(i);
       elseif strcmp(fields{field_id},'bin')
           curr_thresh = threshold_data.bin_cutoffs(i);
       end
...
% Calcaulte Voronoi cells and local densities, constrained by cell ROI; um units
...
poly_to_drop = poly_to_drop | (poly_dens<thresholdvalue);
...
all_segmented_clusters = segmented_clusters;
end
