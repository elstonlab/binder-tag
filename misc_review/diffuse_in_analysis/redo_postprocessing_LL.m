...
for i=1:numel(nMinTracksToTest)
    analfile1 = [sprintf('20180524_0328-0405_noAd_100pg_analyzed_cluster_props_maxRI4-00s_minTrk%02d_maxClusSize-0-60um_SPTacqTime60.mat', nMinTracks)];
    analfile2 = [sprintf('20180628_noAd_0109_100pganalyzed_cluster_props_maxRI4-00s_minTrk%02d_maxClusSize-0-60um_SPTacqTime60.mat', nMinTracks)];
    analfile3 = [sprintf('20180628_noAd_0128_100pganalyzed_cluster_props_maxRI4-00s_minTrk%02d_maxClusSize-0-60um_SPTacqTime60.mat', nMinTracks)];
    analfile4 = [sprintf('20180628_noAd_0617_100pganalyzed_cluster_props_maxRI4-00s_minTrk%02d_maxClusSize-0-60um_SPTacqTime60.mat', nMinTracks)];

    measfile1 = ['20180524_0328-0405_noAd_100pg_measured_cluster_props.mat'];
    measfile2 = ['20180628_noAd_0109_100pgmeasured_cluster_props.mat'];
    measfile3 = ['20180628_noAd_0128_100pgmeasured_cluster_props.mat'];
    measfile4 = ['20180628_noAd_0617_100pgmeasured_cluster_props.mat'];

    analfiles = {analfile1, analfile2, analfile3, analfile4};
    measfiles = {measfile1, measfile2, measfile3, measfile4};
    
    savename = [sprintf('annotated_propdists_wRecToClus_minTrk%02d',nMinTracks)];
