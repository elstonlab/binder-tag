function dists = markov_distributions(k1,k2,k4,k6,k7,k8,f1)
% 20191001, J. Cody Herron & Mike Pablo:
% ---------------------------------------------------------
% Description:
%
%   markov_distributions returns Binder-Tag MC distributions.
%
% Example:
%    markov_distibutions(6.48905965,  6.63210682,  1.78802208,  2.38706198,  1.29793274,12.54244379,  0.16762255,  0.13129243)
%
% Input Arguments:
...
dists = {transpose(tag_codiff_dist),transpose(binder_codiff_dist), ...
    transpose(dist_all_tag), transpose(sim_cat), ...
    transpose(sim_process_1_dist), transpose(sim_process_2_dist), ...
    transpose(sim_process_3_dist),transpose(sim_process_4_dist)};
