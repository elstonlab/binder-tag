function error_final = markov_score_final_wPlot(k1,k2,k3,k4,k5,k6,k7,k8,f1,dt,plot_figures)
...
if plot_figures == 1
    ...
    legend({'tagSrc Experimental', 'tagSrc Simulation'});
    ...
    ylabel('Co-diffusion events (%)');
    legend({'Binder Experimental', 'Binder Simulation'});
    ...
    xlabel('Lifetime (ms)');
    ylabel('Events (%)');
    legend({'process Time (i) Experimental', 'process Time (i) Simulation'});
    ...
    xlabel('Lifetime (ms)');
    ylabel('Events (%)');
    legend({'process Time (ii) Experimental', 'process Time (ii) Simulation'});
    ...
    xlabel('Lifetime (ms)');
    ylabel('Events (%)');
    legend({'process Time (iii) Experimental', 'process Time (iii) Simulation'});
    ...
    xlabel('Lifetime (ms)');
    ylabel('Events (%)');
    legend({'process Time (iv) Experimental', 'process Time (iv) Simulation'});
