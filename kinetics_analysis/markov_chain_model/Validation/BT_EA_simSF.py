...
crossover_rate = 0.5
number_of_params = 8
filename = 'BT_simSF_1231.txt'
simData = 'simSF123120.mat'
...
def ScoreFxn(learned_params):
    ...
    error = eng.markov_score_simSF(k1, k2, k3, k4, 0.0, k6, k7, k8, f1, 0.001,simData)
    return error
...
for i in range(number_of_runs):
    ...
    for a in range(len(logbook)):
        ...
        ind_np_conv = convert_individual(ind_np, arr_conversion_matrix, number_of_params,dtype=object)
