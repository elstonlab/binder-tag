function update_analysis_results()
...
sourcedir = '/Volumes/Groups/Elston Lab/MikePablo/20180504-bindertag/20190410_rerun_pipeline_and_binomanalysis/result/';
...
meas1=load([sourcedir '20180524_0328-0405_noAd_100pg_measured_cluster_props.mat']);
meas2=load([sourcedir '20180628_noAd_0109_100pgmeasured_cluster_props.mat']);
meas3=load([sourcedir '20180628_noAd_0128_100pgmeasured_cluster_props.mat']);
meas4=load([sourcedir '20180628_noAd_0617_100pgmeasured_cluster_props.mat']);
...
anal1=load([sourcedir '20180524_0328-0405_noAd_100pg_analyzed_cluster_props_maxRI4-00s_minTrk10_maxClusSize0-60um_SPTacqTime60.mat']);
anal2=load([sourcedir '20180628_noAd_0109_100pganalyzed_cluster_props_maxRI4-00s_minTrk10_maxClusSize0-60um_SPTacqTime60.mat']);
anal3=load([sourcedir '20180628_noAd_0128_100pganalyzed_cluster_props_maxRI4-00s_minTrk10_maxClusSize0-60um_SPTacqTime60.mat']);
anal4=load([sourcedir '20180628_noAd_0617_100pganalyzed_cluster_props_maxRI4-00s_minTrk10_maxClusSize0-60um_SPTacqTime60.mat']);
...
[path1_tag,file1_tag]=batchGetPath('/Volumes/Groups/Elston Lab/MikePablo/20180716 - satadrive backup/20180524_bintag_0328-0405_mergecopy/','RightCali_lvPALM','mat');
[path2_tag,file2_tag]=batchGetPath('/Volumes/Groups/Elston Lab/MikePablo/20180716 - satadrive backup/20180628_more_noAd/to_LL/01092018_100pg/inputdata/','RightCali_lvPALM','mat');
[path3_tag,file3_tag]=batchGetPath('/Volumes/Groups/Elston Lab/MikePablo/20180716 - satadrive backup/20180628_more_noAd/to_LL/01282018_100pg/inputdata/','RightCali_lvPALM','mat');
[path4_tag,file4_tag]=batchGetPath('/Volumes/Groups/Elston Lab/MikePablo/20180716 - satadrive backup/20180628_more_noAd/to_LL/06172018_100pg/inputdata/','RightCali_lvPALM','mat');

[path1_bin,file1_bin]=batchGetPath('/Volumes/Groups/Elston Lab/MikePablo/20180716 - satadrive backup/20180524_bintag_0328-0405_mergecopy/','Left_lvPALM','mat');
[path2_bin,file2_bin]=batchGetPath('/Volumes/Groups/Elston Lab/MikePablo/20180716 - satadrive backup/20180628_more_noAd/to_LL/01092018_100pg/inputdata/','Left_lvPALM','mat');
[path3_bin,file3_bin]=batchGetPath('/Volumes/Groups/Elston Lab/MikePablo/20180716 - satadrive backup/20180628_more_noAd/to_LL/01282018_100pg/inputdata/','Left_lvPALM','mat');
[path4_bin,file4_bin]=batchGetPath('/Volumes/Groups/Elston Lab/MikePablo/20180716 - satadrive backup/20180628_more_noAd/to_LL/06172018_100pg/inputdata/','Left_lvPALM','mat');
...
save('annotated_propdists_wRecToClus','allanal');
end
